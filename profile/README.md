...
**[`keyoku`](https://github.com/keyoku-ai/keyoku)** — TypeScript SDK & OpenClaw plugin

[![npm](https://img.shields.io/npm/v/@keyoku/openclaw?label=%40keyoku%2Fopenclaw&style=flat-square&color=6366f1)](https://www.npmjs.com/package/@keyoku/openclaw) [![License: MIT](https://img.shields.io/badge/License-MIT-22c55e?style=flat-square)](https://github.com/keyoku-ai/keyoku/blob/main/LICENSE)

Auto-recall, auto-capture, heartbeat, 7 memory tools, CLI

</td><td width="50%" valign="top">

**[`keyoku-engine`](https://github.com/keyoku-ai/keyoku-engine)** — Memory engine in Go
